...
fakeDoctorsKaBioData = [
    ...
    (
        ...
        "Cardiologist", "Neurologist", "Gynaecologist", "Audiologist", "Radiologist", "Cardiologist",
        "Orthopaedic surgeon", "Neurologist"
    ),
    (
        'Noida, Uttar pradesh', 'Rohini, Delhi', 'gurgaon, haryana', 'Shimla, Himachal Pradesh',
        'Lucknow, Uttar Pradesh',
        'Pune, Maharashtra', 'Jaipur, Rajasthan', 'Kullu, Himachal', 'Ghaziabad, Uttar Pradesh',
        'Indore, Madhya Pradesh',
        'Bhopal, Madhya Pradesh', 'Gwalior, Madhya Pradesh', 'Panchkula, Haryana', 'Sonipat, Haryana',
        'Chandigarh, Haryana', 'Greater Mumbai, Maharashtra', 'Meerut, Uttar Pradesh', 'Agra, Uttar Pradesh',
        'Indore, Madhya Pradesh', 'Manali, Himachal Pradesh'
    ),
    (
        "MKF2sh", "nF1B37", "wLP6IY", "66kwQ2", "hFr1bX", "yx_E5iwa", "_!5ZhX{G", "1G?iI)v<", "{GyBg$7d", "sdSb4]D",
        "'HQ:t8u`", "xNW9+8y", "2pm+>Xm)", "N6WiytSI", "bek7jDxj", "nL2Qr9E7", "cYWEr7ZL", "C6iv1GtF", "qxnqLS4u",
        "SsyST2bo"
    )
]
l1 = []
